...
def read_dst(infile, debug=False):
    ...
    for j,l in enumerate(lines):
        ...
        for k in range(0, 24, 1):
            data3 = (l1[11:13]+l1[0:2]+l1[2:4]+l1[5:7]+str(k)) # Stringing together only the parts that contribute to
    ...
    dst_data = {}  # empty dictionary.

    dst_data['time'] = date_time # add the date_time array to data2 dictionary under keyword time
    dst_data['dst'] = data # add the data array to data2 dictionary under keyword time
    return(dst_data)
